...
public class MessageKey {
    public static final String ACTOR_GET_DETAIL = "actor.get_details";
    public static final String ACTOR_CREATE_SUCCESS = "actor.create_success";
    ...
    public static final String FORMAT_UPDATE_SUCCESS = "format.update_success";
    ...
    public static final String LIMIT_AGE_UPDATE_SUCCESS = "limit_age.update_success";
    ...
    public static final String SEAT_UPDATE_SUCCESS = "seat.update_success";
